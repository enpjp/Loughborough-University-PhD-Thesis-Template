% Going off the Thesis guidelines available here: 
https://www.lboro.ac.uk/services/doctoral-college/essential-information/code-of-practice/appendices/
...
% Line spacing defined at 1 and a half to match Microsoft Word format.
% This is because linespread multiplies the standard 1.2 line spacing
% by the factor supplied here. It just works!
\linespread{1.3}
